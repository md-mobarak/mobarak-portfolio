const Education = () => {
  return (
    <div className="bg-success lg:px-20 px-10 py-20 font-serif">
      <h1 className="lg:text-5xl text-2xl text-center lg:text-start text-info font-bold my-10 uppercase">
        Education
      </h1>
      ...
      <section className="lg:flex w-full">
        ...
        <div className="lg:relative lg:w-1/2 py-8 " data-aos="fade-left">
          <div
            data-aos="fade-up"
            data-aos-duration="1000"
            className="w-10 h-10  lg:absolute hidden lg:block   top-0 left-[-55px]  rounded-full bg-info "
          ></div>
          <div className=" bg-gradient-to-b from-info to-gray-200 p-6 rounded-md shadow-md">
            <div className="text-2xl font-bold mb-4">2019-2023</div>
