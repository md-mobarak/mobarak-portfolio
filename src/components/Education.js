...
//         } lg:px-20 px-10 lg:py-20 py-10 font-serif relative`}
//     >
...
//       <h1
//         className={`lg:text-5xl  lg:mt-0 mt-20 mb-16 text-3xl font-bold ${toggleColor ? "text-info" : "text-success"
...
//             data-aos="fade-up"
//             data-aos-duration="1000"
//             className={`w-8 h-8  lg:absolute hidden lg:block   top-[-20px] right-[-52px]  rounded-full ${toggleColor ? "bg-info" : "bg-accent"
//               } `}
//           ></div>
...
//         </div>
//         <div
//           className={`lg:relative  hidden lg:block w-2  mx-8  border ${toggleColor ? "border-info bg-info" : "border-accent bg-accent"
//             }  `}
//         ></div>
...
//           <div
//             className={`w-32 h-32 blur-sm hidden lg:block  absolute bottom-0  animate-move left-10 opacity-70  rounded-xl  ${toggleColor ? "bg-info" : " hidden"
//               } `}
//           ></div>
//         </div>
//         <div
...
//             data-aos="fade-up"
//             data-aos-duration="1000"
//             className={`w-10 h-10  lg:absolute hidden lg:block   top-0 lg:left-[-55px]  rounded-full ${toggleColor ? "bg-info " : "bg-accent"
//               }`}
//           ></div>
//           <div
//             className={` ${toggleColor
